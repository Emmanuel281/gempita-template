              ...
              <React.Fragment key={`menu-${i}`}>
                {menu.hasChildren ? (
                  <li className="nav-item nav-dropdown group relative">
                    ...
                    <ul className="nav-dropdown-list hidden md:invisible group-hover:block md:absolute md:block md:opacity-0 md:group-hover:visible md:group-hover:opacity-100">
