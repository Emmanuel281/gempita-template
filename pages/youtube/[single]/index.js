...
const Article = () => {
  ...
  let { data : posts, error : iserror, isLoading } = useSWR(`https://adm.gempitamilenial.org/service/youtube-video-public/${single.single}?start=1&count=${pagination}`, fetcher)
